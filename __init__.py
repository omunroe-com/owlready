...
class Ontology(object):
  ...
  def add(self, o):
    ...
    _iri_changed(o, "%s%s%s" % (o.ontology.base_iri, o.owl_separator, o.name), "%s%s%s" % (self.base_iri, o.owl_separator, o.name))
    o.ontology = self
...
owlready_ontology = get_ontology(OWLREADY_ONTOLOGY_IRI).load()
del onto_path[0]
